...
metric_defaults = EasyDict([(args.name, args) for args in [
    # ADA paper.
    EasyDict(name='fid100_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=100, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), # ! added code
    EasyDict(name='fid200_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=200, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), # ! added code
    ...
    EasyDict(name='kid100_full',     class_name='metrics.kernel_inception_distance.KID',  max_reals=1000, num_fakes=100, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), # ! added code
