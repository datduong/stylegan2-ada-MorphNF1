...
class Projector:
    def __init__(self):
        self.num_steps                  = 1000
        self.dlatent_avg_samples        = 200 # ! we don't need 10000, we have very small samples? 
    ...
    def set_network(self, Gs, dtype='float16'):
        ...
        dlatent_samples = self._Gs.components.mapping.run(latent_samples, None)  # [N, L, C] # ! create W vectors, so we are not using Z.? is that possible?
