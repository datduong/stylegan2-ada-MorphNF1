...
# model=$path/network-snapshot-002022.pkl
# cd /data/duongdb/stylegan2-ada
...
# model_path=$maindir/$expterimenttype/'00000-Tfrecord256wLabel-mirror-auto1-ada-target0.7-bgc-resumeffhq256/network-snapshot-002022.pkl'
...
# python3 run_interpolate.py $maindir/$expterimenttype/'00000-Tfrecord256wLabel-mirror-auto1-ada-target0.7-bgc-resumeffhq256/' 'network-snapshot-002022.pkl' $recon_img/'00013-project-real-images' $recon_img/'00014-project-real-images' 

# # ! interpolate label space. notice something is strange. the images reconstructed is not the same as @generate.py ???
# cd /data/duongdb/stylegan2-ada/Interpolate 
# recon_img=/data/duongdb/stylegan2-ada/results
# python3 run_interpolate_label.py $maindir/$expterimenttype/'00000-Tfrecord256wLabel-mirror-auto1-ada-target0.7-bgc-resumeffhq256/' 'network-snapshot-002022.pkl' 
