...
path='/data/duongdb/NF1BeforeAfterInter02012021/Crop/training-stylegan2-ada-Lab3-aveLabEmb/00002-Tfrecord256wLabel-mirror-auto2-ada-target0.7-bgcfnc-resumeffhq256'
model=$path/network-snapshot-001024.pkl ## ! the latest save is bad? 000768 is best
cd /data/duongdb/stylegan2-ada
...
model_path=$maindir/$expterimenttype/'00002-Tfrecord256wLabel-mirror-auto2-ada-target0.7-bgcfnc-resumeffhq256/network-snapshot-001024.pkl'
...
recon_img=$maindir/$expterimenttype/'00002-Tfrecord256wLabel-mirror-auto2-ada-target0.7-bgcfnc-resumeffhq256/'
...
python3 run_interpolate.py $maindir/$expterimenttype/'00002-Tfrecord256wLabel-mirror-auto2-ada-target0.7-bgcfnc-resumeffhq256/' 'network-snapshot-001024.pkl' $recon_img/'00000-project-real-images' $recon_img/'00001-project-real-images' $truncationpsi


cd $maindir/$expterimenttype/'00002-Tfrecord256wLabel-mirror-auto2-ada-target0.7-bgcfnc-resumeffhq256/' 
mkdir network-snapshot-001024
mv $recon_img/'00000-project-real-images' $recon_img/'00001-project-real-images' Same* Interpolate Gen*Interpolate network-snapshot-001024
...
# python3 run_interpolate_label.py $maindir/$expterimenttype/'00002-Tfrecord256wLabel-mirror-auto2-ada-target0.7-bgcfnc-resumeffhq256/' 'network-snapshot-001024.pkl' 
