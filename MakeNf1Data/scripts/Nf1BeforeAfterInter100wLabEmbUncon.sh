...
# python3 train.py \
# --data=/data/duongdb/NF1BeforeAfterInter02012021/Crop/SmallBigGanDataCopy2Tfrecord \
# --mirror=1 \
# --aug=ada --target=0.7 \
# --augpipe=bgcfnc \
# --resume=ffhq1024 --snap=10 \
# --outdir=/data/duongdb/NF1BeforeAfterInter02012021/Crop/training-runs-stylegan2-ada \
# --dry-run
...
--augpipe=bgc \
--metrics=fid100_full \
--outdir=/data/duongdb/NF1BeforeAfterInter02012021/Crop/training-stylegan2-ada-Lab3-BaseLabEmb \
...
path='/data/duongdb/NF1BeforeAfterInter02012021/Crop/training-stylegan2-ada-Lab3-BaseLabEmb/00001-Tfrecord256wLabel-mirror-auto2-ada-target0.7-bgc-resumeffhq256'
model=$path/network-snapshot-001280.pkl
cd /data/duongdb/stylegan2-ada
...
model_path=$maindir/$expterimenttype/'00001-Tfrecord256wLabel-mirror-auto2-ada-target0.7-bgc-resumeffhq256/network-snapshot-001280.pkl'
...
python3 run_interpolate.py $maindir/$expterimenttype/'00001-Tfrecord256wLabel-mirror-auto2-ada-target0.7-bgc-resumeffhq256/' 'network-snapshot-001280.pkl' $recon_img/'00000-project-real-images' $recon_img/'00001-project-real-images' $truncationpsi


cd $maindir/$expterimenttype/'00001-Tfrecord256wLabel-mirror-auto2-ada-target0.7-bgc-resumeffhq256/' 
mkdir network-snapshot-001280
mv $recon_img/'00000-project-real-images' $recon_img/'00001-project-real-images' Same* Interpolate Gen*Interpolate network-snapshot-001280
...
# python3 run_interpolate_label.py $maindir/$expterimenttype/'00001-Tfrecord256wLabel-mirror-auto2-ada-target0.7-bgc-resumeffhq256/' 'network-snapshot-001280.pkl' 
